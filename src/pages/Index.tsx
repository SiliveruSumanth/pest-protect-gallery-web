...
import { Shield, Bug, Home, Star, Phone, Mail, MapPin, Users, Zap, Clock, Award, Menu, X, Calendar, CheckCircle, Truck, Shield as ShieldIcon, Leaf } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                { name: 'Termite Control', icon: Home, description: 'Advanced termite detection and treatment to protect your property' },
                { name: 'Lizard Removal', icon: Bug, description: 'Safe and effective lizard removal and prevention methods' },
                { name: 'Rat or Mice Control', icon: Bug, description: 'Comprehensive rodent elimination and prevention solutions' },
                { name: 'Flies Control', icon: Bug, description: 'Effective fly control for homes and commercial spaces' },
                { name: 'Red & Black Ants Control', icon: Bug, description: 'Complete ant colony elimination and prevention' },
                { name: 'Bed Bugs Removal', icon: Bug, description: 'Thorough bed bug treatment for peaceful sleep' },
              ].map((service, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-6 text-center">
